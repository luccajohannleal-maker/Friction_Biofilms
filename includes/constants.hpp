...
{ //-------------------- Paramters that one might need to change if needed-----------------//
  ...
  inline constexpr double baseTimeScale { baseZeta / baseModE };       // hours
  ...
  // ------------------------ RodShapedBacterium = base drag coefficient -------------------------------

  // Dimensional
  inline constexpr double rodGrwthRtePreFac{ 5 };     // microns/hour -> THIS IS THE PARAMETER TO CHANGE TO ALTER THE GROWTH RATE OF THE ROD-SHAPED BACTERIA
  ...
  inline constexpr double rodZeta{baseZeta};                 // Pa h 
